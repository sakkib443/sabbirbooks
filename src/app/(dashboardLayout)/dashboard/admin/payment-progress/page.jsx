  ...
  return (
    <div className="space-y-5">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
        <div>
          <h1 className="text-xl font-bold text-dash-ink2 outfit">Payment Progress</h1>
          <p className="text-xs text-dash-mute2 mt-0.5">Select a batch to view student payment details</p>
        </div>
      ...
      <div className="flex flex-wrap items-center gap-2.5">
        <div className="flex items-center gap-1.5 bg-dash-card border border-dash-line rounded-lg px-3 py-2 w-56">
          ...
          <input type="text" value={searchQuery} onChange={e => setSearchQuery(e.target.value)}
            ...
            className="text-sm text-dash-ink4 outline-none bg-transparent w-full" />
              ...
              <Link key={batch._id} href={`/dashboard/admin/payment-progress/${batch._id}`}
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div className="flex-1 min-w-0">
                    <h3 className="text-sm font-semibold text-dash-ink2 truncate group-hover:text-teal-700 transition-colors">
