...
const EN = {
  ...
  nickname: 'Call name',
  nicknamePh: 'e.g. Sakib',
  nicknameHint: 'Your coupon code is built from this. Leave it blank and we will pick a name from the one above.',
  phone: 'Phone number',
  phonePh: '01XXXXXXXXX',
...
const BN = {
  ...
  nickname: 'ডাক নাম',
  nicknamePh: 'যেমন: Sakib',
  nicknameHint: 'আপনার কুপন কোড এটা দিয়েই তৈরি হবে। ফাঁকা রাখলে উপরের নাম থেকে বেছে নেওয়া হবে।',
  phone: 'ফোন নম্বর',
  phonePh: '01XXXXXXXXX',
